export default
    [
        ...
        },
        {
            mobile: false,
            name: 'benTube',
            description: 'THIS SITE IS DOWN FOR REPAIR :(... benTube fetches a list of YouTube videos related to user input and converts any video to a .mp3 file.  After conversion, the audio file is played in your browser window. Audio playback will continue after locking your screen on mobile devices.  I built this as a proof of concept and it is explicitly for my own private use.',
            ...
            images:
                [
                    './res/screenshots/hackify/1.png',
                    './res/screenshots/hackify/2.png',
                    './res/screenshots/hackify/3.png',
                    './res/screenshots/hackify/4.png',
